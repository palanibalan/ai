...
function startStage() {
    ...
    switch (stages[currStage]) {
        case 'sayHi':
            // have student say, "Hi 2Ring.ai"
            // 1. write, "Say hi" in textbox
            infoLabel.innerHTML = 'Say "hi"!';
            break;
        case 'zAskName':
            // have 2Ring.ai say, "Hi there! What’s your name?"

            var phrases = ["Hello buddy! I don't think we've met. What's your name?",
        ...
        case 'respondWithName':
            ...
            infoLabel.innerHTML = '2Ring.ai says, "What\'s your name?"';
            // 2. have student say, "I’m <name>" or "<name>" etc.
            // 3. this will take us to the "afterRecording" and then "introReceiveData()" 
            // method
            // 4. 2Ring.ai will respond, asking where they're from
			ReplacingImagemouth();
            break;
        case 'respondWithPlace':
            // 1. have student say, "I’m from <place>" or "<place>" etc.
            infoLabel.innerHTML = '2Ring.ai says, "Where are you from?"';
            // 2. this will take us to the "afterRecording" and then "introReceiveData()" 
            // method 
            // 3. 2Ring.ai will respond with "Interesting! I've never heard of <place>, before. 
            // I'd love to learn more."
			ReplacingImagehandmouth();
            break;
        case 'zFinish':
            infoLabel.innerHTML = 'Find out what 2Ring.ai knows about your planet!';
            // change button to Activity 1 button: Ask 2Ring.ai about ecosystems
			ReplacingImage();
            break;
        default:
            console.error("Unknown stage for conversation with 2Ring.ai: " + stages[currStage]);
    }
    ...
    switch (stages[currStage]) {
        ...
        case 'respondWithPlace':
            ...
            if (filedata.trim() && !filedata.includes('ERR_NO_TEXT')) {
                ...
                recordingIsGood = true;
                phrases = ["Ooo, " + currPlace + " sounds interesting! I'm from planet krypton, so I've never heard of " + currPlace + " before! Tell me more!",
                    currPlace + " sounds cool! I have no idea where that is, since I'm from another planet! I'd love to hear more!",
                    "Interesting! I'm from planet krypton. I've never heard of " + currPlace + " before. Can you tell me more?"
                ];
            } else {
                phrases = ["I didn't quite catch that.", "Sorry, I missed that.", "Pardon?",
