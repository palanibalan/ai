...
function mod3ReceiveData(filedata, stage) {
    if (stage.includes('mindmap')) {
        ...
        if (!filedata.includes('ERR_NO_TEXT')) {
            ...
            // comes from.":
            phrases = ["Based on what I know about countries, I would guess " + animal +
                " is he most spoken language in" + eco + ".",
                "I would guess " + animal + " is the most spoken language in " + eco + " from what I know.",
                "I think " + animal + " is the most spoken language in " + eco + " based on what you told me."
            ];
ReplacingImagemouth();
            createHistogram(ecoData);
        } else {
            // error checking:
            phrases = ["I don't know enough about that country to guess the language.",
                "I haven't heard enough about that country.",
                "Hmm, I'm not sure! I haven't heard much about that country"
            ];
			ReplacingImagehandmouth();
        }
