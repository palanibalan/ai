...
function setAnimalPrompt() {
    animalPromptLabel.innerHTML = "2Ring.ai would like to know about <span style=\"text-decoration: underline;\">" +
        currentAnimal + "</span>. Could you teach it about them?";
    textFileLabel.innerHTML = "Once you're done teaching 2Ring.ai about " +
